...
?>
<h4 class="animated infinite heartBeat "align="center">Input Data Pengumuman</h4>
...
<form method="post" class="form-horizontal" action="">
	...
	<a href="aplikasi.php?p=add_pengumuman" class="btn btn-primary pull-right">Add <i class="fa fa-plus"></i></a>
</form>
<hr>
<br>
	<?php
	...
	$no=0;
	 while($r = mysqli_fetch_array($result)) {
		  ...
		  <tr>
			...
			<td>
				<!-- <a style="width:80px"  class="btn btn-xs btn-warning" href="?p=edit_pengumuman&id=<?php echo $r['id']; ?>">
					<span class="fa fa-edit"></span> Update</a> -->
				<a  style="width:80px" class="btn btn-xs btn-danger" onclick="return confirm('Apakah yakin akan dihapus?')" href="app/pengabdian/pengumuman/hapus.php?id=<?php echo $r['id_pengumuman']; ?>">

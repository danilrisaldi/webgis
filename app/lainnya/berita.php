				...
				?>
						<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php echo $page;?> <span class="caret"></span></a>
							<ul class="dropdown-menu">
								...
								?>
								<li><a href="app/lainnya/berita.php?p=<?php echo $idsub; ?>"><?php echo $sub; ?></a></li>
								<?php endwhile; ?>
							</ul>
						</li>
				<?php else: ?>
						<li><a href="app/lainnya/berita.php?p=<?php echo $idpage; ?>"><?php echo $page;?></a></li>
				<?php 
					endif;
				endwhile; ?>
		  ...
		  <div class="span12" id="containt">
			...
			<div class="row-fluid" id="content">
				<ul class="postings">
					...
					else: $sqlnews.=" order by id_page desc";
					endif;
				...
				<li class="span6 posting" style="padding: 5px; min-height: 165px; max-height: 160px; display: block; overflow: auto;">
						...
						<h4><a href="berita.php?p=<?php echo $idn; ?>"><?php echo $jdln; ?></a></h4>
						<?php echo $deskn; ?>
						<p><a href="berita.php?p=<?php echo $idn; ?>" class="btn btn-inverse">readmore &raquo;</a></p>

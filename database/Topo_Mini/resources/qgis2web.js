...
var map = new ol.Map({
    controls: ol.control.defaults({attribution:false}).extend([
        expandedAttribution ,new ol.control.FullScreen({}),new measureControl(),new geolocateControl()//,new ol-control.FullScreen({})
    ]),
...
map.getView().fit([11428731.189429, -377156.367089, 11480257.568897, -347995.599429], map.getSize());
